              ...
              <Card className="bg-background/80 backdrop-blur-sm border-primary/20 shadow-card">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input type="tel" className="border-primary/20 focus:border-primary" />
                  </div>
                  ...
                  <Button className="w-full font-sans bg-primary text-primary-foreground hover:bg-primary-glow shadow-golden">
                    Envoyer le Message
                  </Button>
